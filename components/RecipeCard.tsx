              ...
              <div className="w-80">
                ...
                <div className="border-t p-6 bg-white dark:bg-gray-800 rounded-b-3xl">
                  ...
                  <Link href={`/recipes/${slug}`}>
                    <a className="text-indigo-700 bg-transparent border-indigo-700 dark:text-gray-100 dark:bg-indigo-700 border px-4 py-2 text-sm font-medium leading-3 rounded focus:outline-none mt-5 hover:opacity-50">
                      Recipe details
                    </a>
                  </Link>
                </div>
