...
function RecipeItem({recipe}) {
    return recipe?.map((item, index) => {
        return (<div className="lg:w-4/12 lg:mr-7 lg:mb-0 mb-7 bg-white p-6 shadow rounded" key={index}>
            <div className="flex items-center border-b border-gray-200 pb-6">
                <img src="https://cdn.tuk.dev/assets/components/misc/doge-coin.png"
                     className="w-12 h-12 rounded-full"/>
                <div className="flex items-start justify-between w-full">
                    <div className="pl-3 w-full">
                        <p className="text-xl font-medium leading-5 text-gray-800">{item.title}</p>
                    ...
                    <svg width={28} height={28} viewBox="0 0 28 28" fill="none"
                        ...
                        <path
                            ...
                            stroke="#2C3E50" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </div>
            </div>
            <div className="px-2">
                <p className="text-sm leading-5 py-4 text-gray-600">{item.description}</p>
                <div className="flex">
                    <div
